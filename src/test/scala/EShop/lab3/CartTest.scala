...
class CartTest
  ...
  it should "add item properly" in {
    ...
    testCartActor ! AddItem("portfel")
    testCartActor ! AddItem("koszula")
    testCartActor ! AddItem("marynarka")
    testCartActor ! AddItem("niewolnik")

    (testCartActor ? CartActor.GetItems)
      .mapTo[Seq[Any]]
      .futureValue shouldBe Seq[Any]("portfel", "koszula", "marynarka", "niewolnik")
  }
  ...
  it should "be empty after adding and removing the same item" in {
    ...
    testCartActor ! AddItem("portfel")
    testCartActor ! AddItem("koszula")
    testCartActor ! RemoveItem("portfel")
    testCartActor ! RemoveItem("koszula")
